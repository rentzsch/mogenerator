...
/**
    ...
    store file.  This code uses a folder named "mogeneratorTestMule" for
...
- (NSString *)applicationSupportFolder {
    ...
    return [basePath stringByAppendingPathComponent:@"mogeneratorTestMule"];
}
...
- (NSPersistentStoreCoordinator *) persistentStoreCoordinator {
    ...
    url = [NSURL fileURLWithPath: [applicationSupportFolder stringByAppendingPathComponent: @"mogeneratorTestMule.xml"]];
